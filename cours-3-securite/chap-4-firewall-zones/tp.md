...
> 9204). Le SSH (22) ne doit être joignable QUE depuis ton poste (le réseau de
...
1. Tu as ajouté l'entrée bastion mais **oublié de relancer le playbook** — le
   fichier `9204.fw` n'existe pas encore sur le nœud.
2. Ne lis pas le service : **lis les règles** (le réflexe du chapitre !). SUR LE
   NŒUD Proxmox : `pve-firewall compile | grep -A20 'VM 9204'`. Si tu ne vois pas
