...
cd "$ARBRE"
ansible-playbook playbooks/zone-firewall.yml   # écrit /etc/pve/firewall/602.fw
...
# pve-firewall compile | grep -A20 'VM 602'   # policy DROP + seule règle : 22 depuis le management
